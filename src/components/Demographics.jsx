...
const Demographics = () => {
  ...
  return (
    <div className="rounded-lg p-4 bg-zinc-800 text-white flex flex-col gap-4 mb-32 xl:max-h-96 2xl:max-h-[28rem] relative">
      ...
      <div className='flex flex-col gap-4 xl:flex-row'>
        ...
        <div className="flex flex-col gap-4 mt-6 border-b pb-4 md:gap-6 border-white/20 xl:w-1/3">
